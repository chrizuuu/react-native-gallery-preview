...
| `statusBarProps?`        | `StatusBarProps`                                        | Props forwarded to the StatusBar rendered inside the gallery modal, spread over the library defaults. Lets you control `translucent`, `barStyle`, `backgroundColor`, `hidden`, etc. When omitted, the previous behavior is preserved.                                                                                | -     
